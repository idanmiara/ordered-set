...
try:
    ...
    OS1 = OS2
from stableset import StableSet as OS3
from stableset import OrderedSet as OS4
from sortedcollections import OrderedSet as OS5
...
ordered_sets_types = [OS1, OS2, OS3, OS4, OS5]
